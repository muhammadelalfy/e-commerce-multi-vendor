...
<head>
    ...
    <!-- Font Awesome Icons -->
    <link rel="stylesheet" href="<?php echo asset('plugins/fontawesome-free/css/all.css')  ?>">
    <!-- Theme style -->
...
<div class="wrapper" >
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="{{asset('dist/img/AdminLTELogo.png')}}" alt="{{env('APP_NAME')}}" class="brand-image img-circle elevation-3" style="opacity: .8">

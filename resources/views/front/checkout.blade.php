                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.select name="addr[billing][country]" :options="$countries"  placeholder="Country" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.select name="addr[shipping][country]" :options="$countries"  placeholder="Country" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="steps-form-btn button">
                                                    ...
                                                    <button href="javascript:void(0)" type="submit"  class="btn btn-alt">Save & Continue</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
